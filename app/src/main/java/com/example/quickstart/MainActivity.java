...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView img1 = (ImageView) findViewById(R.id.imgIcon);
        TextView title = (TextView) findViewById(R.id.title);
        TextView desc = (TextView) findViewById(R.id.desc);
        Button googleAPI = (Button) findViewById(R.id.googleAPI);
...
//        activityLayout.setPadding(16, 16, 16, 16);
        ...
        ViewGroup.LayoutParams tlp = new ViewGroup.LayoutParams(
                ...
                ViewGroup.LayoutParams.WRAP_CONTENT);
        mCallApiButton = (Button) findViewById(R.id.googleAPI);
...
//        activityLayout.addView(mCallApiButton);
        ...
        RelativeLayout activityLayout = (RelativeLayout) findViewById(R.id.linearLayout1);
...
//            new MakeRequestTask(mCredential).execute();
    ...
    public class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        public List<String> getDataFromApi() throws IOException {
            ...
            Log.v("EVECUTING",String.valueOf(items.size()));
    ...
    public class MakeRequestTask2 extends AsyncTask<Void, Void, Void> {
        ...
        MakeRequestTask2(GoogleAccountCredential credential, String calendarId, Event event, Context c) {
